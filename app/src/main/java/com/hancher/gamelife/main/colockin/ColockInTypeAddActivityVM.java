 ...
 * 描述 : 添加打卡类型
 */
public class ColockInTypeAddActivityVM extends VMBaseActivity<ColockInTypeAddActivityBinding, ColockInViewModel> {
    ColockInType type;
    private static final String TITLE = "title";
    private static final String IMAGE = "image";
    private MaterialDialog progress;
    private ColockInTypeAdapter adapter = new ColockInTypeAdapter();
    ...
    private void initObseve() {
        binding.btnFloat.setOnClickListener(v -> {
            progress = new MaterialDialog.Builder(ColockInTypeAddActivityVM.this)
                    .content("保存中...")
                    .show();
            // 检查标题是否为空
