...
import static com.hancher.gamelife.main.colockin.ColockInViewModel.STATE.DELETE_FINISH;
import static com.hancher.gamelife.main.colockin.ColockInViewModel.STATE.SAVE_FINISH;
 ...
 * 描述 : 点击打卡界面vm
 */
public class ColockInViewModel extends BaseViewModel {
    ...
    public void removeColockIn(ColockIn colockIn) {
        AsyncUtils.run(emitter -> {
            ...
            emitter.onNext(STATE.DELETE_FINISH);
            emitter.onComplete();
