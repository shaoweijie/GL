 ...
 * 描述 : 点击打卡界面
 */
public class MoneyListActivityVM extends VMBaseActivity<ColockInListActivityBinding, MoneyViewModel> {
    ...
    private void initObseve() {
        ...
        adapter.setOnItemChildClickListener((adapter, view, position) -> {
            ...
            deleteDialog = new MaterialDialog.Builder(MoneyListActivityVM.this)
                    .title("确定要删除此条打卡吗？")
                    .positiveText("确定")
                    .negativeText("取消")
